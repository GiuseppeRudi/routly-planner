...
(define (domain road-network)
  ...
  (:action traverse-road-static-macro_0009
    :parameters (?v - vehicle ?r - road_type_macro_0009 ?from - loc_type_loc_0039 ?to - loc_type_loc_0091)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-macro_0019
    :parameters (?v - vehicle ?r - road_type_macro_0019 ?from - loc_type_loc_0089 ?to - loc_type_loc_0188)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-macro_0029
    :parameters (?v - vehicle ?r - road_type_macro_0029 ?from - loc_type_loc_0195 ?to - loc_type_loc_0073)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
