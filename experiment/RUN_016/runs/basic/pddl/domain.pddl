...
(define (domain road-network)
  ...
  (:action traverse-road-static-macro_0007
    :parameters (?v - vehicle ?r - road_type_macro_0007 ?from - loc_type_loc_0055 ?to - loc_type_loc_0112)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-macro_0019
    :parameters (?v - vehicle ?r - road_type_macro_0019 ?from - loc_type_loc_0141 ?to - loc_type_loc_0082)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-macro_0020
    :parameters (?v - vehicle ?r - road_type_macro_0020 ?from - loc_type_loc_0143 ?to - loc_type_loc_0018)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
