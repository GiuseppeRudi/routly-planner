...
(define (domain road-network)
  ...
  (:action traverse-road-static-road_0011
    :parameters (?v - vehicle ?r - road_type_road_0011 ?from - loc_type_loc_0008 ?to - loc_type_loc_0151)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0015
    :parameters (?v - vehicle ?r - road_type_road_0015 ?from - loc_type_loc_0011 ?to - loc_type_loc_0241)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0018
    :parameters (?v - vehicle ?r - road_type_road_0018 ?from - loc_type_loc_0012 ?to - loc_type_loc_0252)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0024
    :parameters (?v - vehicle ?r - road_type_road_0024 ?from - loc_type_loc_0016 ?to - loc_type_loc_0186)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0025
    :parameters (?v - vehicle ?r - road_type_road_0025 ?from - loc_type_loc_0016 ?to - loc_type_loc_0002)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0029
    :parameters (?v - vehicle ?r - road_type_road_0029 ?from - loc_type_loc_0021 ?to - loc_type_loc_0225)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0038
    :parameters (?v - vehicle ?r - road_type_road_0038 ?from - loc_type_loc_0026 ?to - loc_type_loc_0090)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0051
    :parameters (?v - vehicle ?r - road_type_road_0051 ?from - loc_type_loc_0032 ?to - loc_type_loc_0030)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0054
    :parameters (?v - vehicle ?r - road_type_road_0054 ?from - loc_type_loc_0034 ?to - loc_type_loc_0207)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0055
    :parameters (?v - vehicle ?r - road_type_road_0055 ?from - loc_type_loc_0035 ?to - loc_type_loc_0036)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0056
    :parameters (?v - vehicle ?r - road_type_road_0056 ?from - loc_type_loc_0035 ?to - loc_type_loc_0208)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0057
    :parameters (?v - vehicle ?r - road_type_road_0057 ?from - loc_type_loc_0036 ?to - loc_type_loc_0296)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0060
    :parameters (?v - vehicle ?r - road_type_road_0060 ?from - loc_type_loc_0038 ?to - loc_type_loc_0279)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0077
    :parameters (?v - vehicle ?r - road_type_road_0077 ?from - loc_type_loc_0045 ?to - loc_type_loc_0043)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0086
    :parameters (?v - vehicle ?r - road_type_road_0086 ?from - loc_type_loc_0051 ?to - loc_type_loc_0059)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0089
    :parameters (?v - vehicle ?r - road_type_road_0089 ?from - loc_type_loc_0052 ?to - loc_type_loc_0284)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0091
    :parameters (?v - vehicle ?r - road_type_road_0091 ?from - loc_type_loc_0053 ?to - loc_type_loc_0072)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0092
    :parameters (?v - vehicle ?r - road_type_road_0092 ?from - loc_type_loc_0054 ?to - loc_type_loc_0250)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0093
    :parameters (?v - vehicle ?r - road_type_road_0093 ?from - loc_type_loc_0054 ?to - loc_type_loc_0048)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0098
    :parameters (?v - vehicle ?r - road_type_road_0098 ?from - loc_type_loc_0057 ?to - loc_type_loc_0256)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0106
    :parameters (?v - vehicle ?r - road_type_road_0106 ?from - loc_type_loc_0063 ?to - loc_type_loc_0167)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0109
    :parameters (?v - vehicle ?r - road_type_road_0109 ?from - loc_type_loc_0065 ?to - loc_type_loc_0066)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0111
    :parameters (?v - vehicle ?r - road_type_road_0111 ?from - loc_type_loc_0066 ?to - loc_type_loc_0056)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0117
    :parameters (?v - vehicle ?r - road_type_road_0117 ?from - loc_type_loc_0070 ?to - loc_type_loc_0016)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0119
    :parameters (?v - vehicle ?r - road_type_road_0119 ?from - loc_type_loc_0072 ?to - loc_type_loc_0071)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0128
    :parameters (?v - vehicle ?r - road_type_road_0128 ?from - loc_type_loc_0079 ?to - loc_type_loc_0296)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0132
    :parameters (?v - vehicle ?r - road_type_road_0132 ?from - loc_type_loc_0081 ?to - loc_type_loc_0126)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0136
    :parameters (?v - vehicle ?r - road_type_road_0136 ?from - loc_type_loc_0084 ?to - loc_type_loc_0073)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0138
    :parameters (?v - vehicle ?r - road_type_road_0138 ?from - loc_type_loc_0086 ?to - loc_type_loc_0143)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0154
    :parameters (?v - vehicle ?r - road_type_road_0154 ?from - loc_type_loc_0095 ?to - loc_type_loc_0063)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0156
    :parameters (?v - vehicle ?r - road_type_road_0156 ?from - loc_type_loc_0096 ?to - loc_type_loc_0095)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0160
    :parameters (?v - vehicle ?r - road_type_road_0160 ?from - loc_type_loc_0098 ?to - loc_type_loc_0190)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0163
    :parameters (?v - vehicle ?r - road_type_road_0163 ?from - loc_type_loc_0100 ?to - loc_type_loc_0292)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0164
    :parameters (?v - vehicle ?r - road_type_road_0164 ?from - loc_type_loc_0100 ?to - loc_type_loc_0101)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0170
    :parameters (?v - vehicle ?r - road_type_road_0170 ?from - loc_type_loc_0102 ?to - loc_type_loc_0199)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0195
    :parameters (?v - vehicle ?r - road_type_road_0195 ?from - loc_type_loc_0114 ?to - loc_type_loc_0008)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0197
    :parameters (?v - vehicle ?r - road_type_road_0197 ?from - loc_type_loc_0115 ?to - loc_type_loc_0011)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0206
    :parameters (?v - vehicle ?r - road_type_road_0206 ?from - loc_type_loc_0120 ?to - loc_type_loc_0086)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0214
    :parameters (?v - vehicle ?r - road_type_road_0214 ?from - loc_type_loc_0125 ?to - loc_type_loc_0112)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0224
    :parameters (?v - vehicle ?r - road_type_road_0224 ?from - loc_type_loc_0131 ?to - loc_type_loc_0133)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0225
    :parameters (?v - vehicle ?r - road_type_road_0225 ?from - loc_type_loc_0131 ?to - loc_type_loc_0133)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0229
    :parameters (?v - vehicle ?r - road_type_road_0229 ?from - loc_type_loc_0133 ?to - loc_type_loc_0131)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0230
    :parameters (?v - vehicle ?r - road_type_road_0230 ?from - loc_type_loc_0133 ?to - loc_type_loc_0131)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0231
    :parameters (?v - vehicle ?r - road_type_road_0231 ?from - loc_type_loc_0133 ?to - loc_type_loc_0130)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0267
    :parameters (?v - vehicle ?r - road_type_road_0267 ?from - loc_type_loc_0150 ?to - loc_type_loc_0127)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0268
    :parameters (?v - vehicle ?r - road_type_road_0268 ?from - loc_type_loc_0151 ?to - loc_type_loc_0114)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0271
    :parameters (?v - vehicle ?r - road_type_road_0271 ?from - loc_type_loc_0154 ?to - loc_type_loc_0009)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0277
    :parameters (?v - vehicle ?r - road_type_road_0277 ?from - loc_type_loc_0157 ?to - loc_type_loc_0295)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0281
    :parameters (?v - vehicle ?r - road_type_road_0281 ?from - loc_type_loc_0160 ?to - loc_type_loc_0158)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0283
    :parameters (?v - vehicle ?r - road_type_road_0283 ?from - loc_type_loc_0161 ?to - loc_type_loc_0079)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0284
    :parameters (?v - vehicle ?r - road_type_road_0284 ?from - loc_type_loc_0161 ?to - loc_type_loc_0252)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0296
    :parameters (?v - vehicle ?r - road_type_road_0296 ?from - loc_type_loc_0167 ?to - loc_type_loc_0166)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0308
    :parameters (?v - vehicle ?r - road_type_road_0308 ?from - loc_type_loc_0176 ?to - loc_type_loc_0104)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0319
    :parameters (?v - vehicle ?r - road_type_road_0319 ?from - loc_type_loc_0184 ?to - loc_type_loc_0067)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0320
    :parameters (?v - vehicle ?r - road_type_road_0320 ?from - loc_type_loc_0186 ?to - loc_type_loc_0285)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0322
    :parameters (?v - vehicle ?r - road_type_road_0322 ?from - loc_type_loc_0187 ?to - loc_type_loc_0006)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0326
    :parameters (?v - vehicle ?r - road_type_road_0326 ?from - loc_type_loc_0190 ?to - loc_type_loc_0099)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0332
    :parameters (?v - vehicle ?r - road_type_road_0332 ?from - loc_type_loc_0193 ?to - loc_type_loc_0244)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0343
    :parameters (?v - vehicle ?r - road_type_road_0343 ?from - loc_type_loc_0199 ?to - loc_type_loc_0293)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0347
    :parameters (?v - vehicle ?r - road_type_road_0347 ?from - loc_type_loc_0201 ?to - loc_type_loc_0203)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0349
    :parameters (?v - vehicle ?r - road_type_road_0349 ?from - loc_type_loc_0202 ?to - loc_type_loc_0205)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0350
    :parameters (?v - vehicle ?r - road_type_road_0350 ?from - loc_type_loc_0202 ?to - loc_type_loc_0203)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0351
    :parameters (?v - vehicle ?r - road_type_road_0351 ?from - loc_type_loc_0203 ?to - loc_type_loc_0210)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0362
    :parameters (?v - vehicle ?r - road_type_road_0362 ?from - loc_type_loc_0207 ?to - loc_type_loc_0035)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0363
    :parameters (?v - vehicle ?r - road_type_road_0363 ?from - loc_type_loc_0208 ?to - loc_type_loc_0209)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0365
    :parameters (?v - vehicle ?r - road_type_road_0365 ?from - loc_type_loc_0209 ?to - loc_type_loc_0156)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0378
    :parameters (?v - vehicle ?r - road_type_road_0378 ?from - loc_type_loc_0218 ?to - loc_type_loc_0145)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0379
    :parameters (?v - vehicle ?r - road_type_road_0379 ?from - loc_type_loc_0219 ?to - loc_type_loc_0253)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0389
    :parameters (?v - vehicle ?r - road_type_road_0389 ?from - loc_type_loc_0225 ?to - loc_type_loc_0022)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0393
    :parameters (?v - vehicle ?r - road_type_road_0393 ?from - loc_type_loc_0229 ?to - loc_type_loc_0075)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0394
    :parameters (?v - vehicle ?r - road_type_road_0394 ?from - loc_type_loc_0229 ?to - loc_type_loc_0098)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0399
    :parameters (?v - vehicle ?r - road_type_road_0399 ?from - loc_type_loc_0233 ?to - loc_type_loc_0076)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0413
    :parameters (?v - vehicle ?r - road_type_road_0413 ?from - loc_type_loc_0241 ?to - loc_type_loc_0007)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0414
    :parameters (?v - vehicle ?r - road_type_road_0414 ?from - loc_type_loc_0241 ?to - loc_type_loc_0240)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0415
    :parameters (?v - vehicle ?r - road_type_road_0415 ?from - loc_type_loc_0242 ?to - loc_type_loc_0102)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0417
    :parameters (?v - vehicle ?r - road_type_road_0417 ?from - loc_type_loc_0243 ?to - loc_type_loc_0292)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0418
    :parameters (?v - vehicle ?r - road_type_road_0418 ?from - loc_type_loc_0244 ?to - loc_type_loc_0246)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0420
    :parameters (?v - vehicle ?r - road_type_road_0420 ?from - loc_type_loc_0245 ?to - loc_type_loc_0243)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0421
    :parameters (?v - vehicle ?r - road_type_road_0421 ?from - loc_type_loc_0246 ?to - loc_type_loc_0245)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0423
    :parameters (?v - vehicle ?r - road_type_road_0423 ?from - loc_type_loc_0247 ?to - loc_type_loc_0287)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0427
    :parameters (?v - vehicle ?r - road_type_road_0427 ?from - loc_type_loc_0250 ?to - loc_type_loc_0150)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0428
    :parameters (?v - vehicle ?r - road_type_road_0428 ?from - loc_type_loc_0252 ?to - loc_type_loc_0161)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0429
    :parameters (?v - vehicle ?r - road_type_road_0429 ?from - loc_type_loc_0252 ?to - loc_type_loc_0012)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0434
    :parameters (?v - vehicle ?r - road_type_road_0434 ?from - loc_type_loc_0255 ?to - loc_type_loc_0028)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0436
    :parameters (?v - vehicle ?r - road_type_road_0436 ?from - loc_type_loc_0256 ?to - loc_type_loc_0064)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0463
    :parameters (?v - vehicle ?r - road_type_road_0463 ?from - loc_type_loc_0273 ?to - loc_type_loc_0027)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0469
    :parameters (?v - vehicle ?r - road_type_road_0469 ?from - loc_type_loc_0279 ?to - loc_type_loc_0280)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0471
    :parameters (?v - vehicle ?r - road_type_road_0471 ?from - loc_type_loc_0280 ?to - loc_type_loc_0279)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0477
    :parameters (?v - vehicle ?r - road_type_road_0477 ?from - loc_type_loc_0284 ?to - loc_type_loc_0267)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0490
    :parameters (?v - vehicle ?r - road_type_road_0490 ?from - loc_type_loc_0292 ?to - loc_type_loc_0242)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0491
    :parameters (?v - vehicle ?r - road_type_road_0491 ?from - loc_type_loc_0293 ?to - loc_type_loc_0199)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0492
    :parameters (?v - vehicle ?r - road_type_road_0492 ?from - loc_type_loc_0293 ?to - loc_type_loc_0231)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0498
    :parameters (?v - vehicle ?r - road_type_road_0498 ?from - loc_type_loc_0296 ?to - loc_type_loc_0045)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
