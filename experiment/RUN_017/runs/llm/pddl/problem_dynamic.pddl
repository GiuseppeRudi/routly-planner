...
(define (problem exp_150_nodes_04_planner_comp_line_param_20260715_153012_dynamic)
  (:domain road-network)
  ...
  (= (travel-duration macro_0005) 23.7517)
  ...
  (= (travel-duration macro_0010) 20.6821)
  ...
  (= (travel-duration macro_0011) 33.8488)
  ...
  (= (congestion-factor macro_0019) 1.35)
  (= (travel-duration macro_0019) 17.7592)
  ...
  (= (travel-duration road_0010) 10.6305)
  ...
  (= (travel-duration road_0018) 5.357)
  ...
  (= (travel-duration road_0022) 1.9282)
  ...
  (= (travel-duration road_0023) 26.5639)
  ...
  (= (travel-duration road_0026) 26.4641)
  ...
  (road-open road_0027)
  (= (congestion-factor road_0027) 1.25)
  (= (travel-duration road_0027) 2.4181)
  ...
  (= (travel-duration road_0035) 47.7364)
  ...
  (= (travel-duration road_0039) 15.1231)
  ...
  (= (travel-duration road_0040) 2.2679)
  ...
  (road-open road_0043)
  (= (congestion-factor road_0043) 1.4)
  (= (travel-duration road_0043) 8.5196)
  ...
  (= (travel-duration road_0044) 2.6174)
  ...
  (= (travel-duration road_0045) 35.0472)
  ...
  (= (travel-duration road_0051) 3.5445)
  ...
  (= (travel-duration road_0052) 12.6203)
  ...
  (road-open road_0054)
  (= (congestion-factor road_0054) 1.45)
  (= (travel-duration road_0054) 7.7033)
  ...
  (= (travel-duration road_0060) 18.6312)
  ...
  (= (travel-duration road_0063) 95.6944)
  ...
  (= (travel-duration road_0066) 49.9563)
  ...
  (= (travel-duration road_0068) 17.9842)
  ...
  (= (travel-duration road_0069) 7.1902)
  ...
  (= (travel-duration road_0071) 25.3839)
  ...
  (road-open road_0073)
  (= (congestion-factor road_0073) 1.31)
  (= (travel-duration road_0073) 19.1351)
  ...
  (= (travel-duration road_0074) 47.6729)
  ...
  (= (travel-duration road_0075) 11.503)
  ...
  (= (travel-duration road_0079) 5.0944)
  ...
  (road-open road_0084)
  (= (congestion-factor road_0084) 1.23)
  (= (travel-duration road_0084) 15.1709)
  ...
  (= (travel-duration road_0094) 13.2357)
  ...
  (= (travel-duration road_0099) 9.6534)
  ...
  (= (travel-duration road_0106) 4.2664)
  ...
  (= (travel-duration road_0109) 29.8335)
  (road-next road_0109 road_0173)
  (road-next road_0109 road_0174)
  (connects road_0110 loc_0071 loc_0025)
  (road-open road_0110)
  (= (congestion-factor road_0110) 1.11)
  (= (travel-duration road_0110) 11.6328)
  ...
  (= (travel-duration road_0114) 7.5215)
  ...
  (road-open road_0115)
  (= (congestion-factor road_0115) 1.6)
  (= (travel-duration road_0115) 2.0449)
  ...
  (= (travel-duration road_0119) 16.7326)
  ...
  (road-open road_0124)
  ;; [DYNAMIC EVENT - roadworks] Roadworks on three roads converging at intersection loc_0081, a low‑degree bridge linking the northern and southern parts of the network. These roads have distances to the axis of 1.9, 13.7, and 0.5 respectively, making the cluster highly influential on the direct path.
  ...
  (road-open road_0127)
  (= (congestion-factor road_0127) 1.5)
  (= (travel-duration road_0127) 9.697)
  ...
  (road-open road_0132)
  (= (congestion-factor road_0132) 1.45)
  (= (travel-duration road_0132) 8.0165)
  (road-next road_0132 road_0072)
  (connects road_0133 loc_0086 loc_0100)
  (road-open road_0133)
  (= (congestion-factor road_0133) 1.1)
  (= (travel-duration road_0133) 9.3816)
  ...
  (= (travel-duration road_0138) 19.4928)
  ...
  (road-open road_0140)
  (= (congestion-factor road_0140) 3.0)  ;; [DYNAMIC EVENT - slowdown] Light congestion on road_0140 (distance to axis 16.3) slows traffic on the 0090‑0059 segment by a factor of 3.0, creating a mild bottleneck near the central axis.
  (= (travel-duration road_0140) 42.3132)  ;; [DYNAMIC EVENT - slowdown] Light congestion on road_0140 (distance to axis 16.3) slows traffic on the 0090‑0059 segment by a factor of 3.0, creating a mild bottleneck near the central axis.
  ...
  (= (travel-duration road_0144) 7.4995)
  ...
  (= (travel-duration road_0148) 16.3796)
  ...
  (road-open road_0151)
  (= (congestion-factor road_0151) 1.3)
  (= (travel-duration road_0151) 1.1092)
  ...
  (= (travel-duration road_0154) 27.8133)
  ...
  (= (travel-duration road_0155) 32.7756)
  ...
  (= (travel-duration road_0157) 6.702)
  ...
  (= (travel-duration road_0159) 8.3466)
  ...
  (road-open road_0161)
  (= (congestion-factor road_0161) 1.26)
  (= (travel-duration road_0161) 7.9398)
  ...
  (road-open road_0166)
  (= (congestion-factor road_0166) 1.17)
  (= (travel-duration road_0166) 0.1825)
  ...
  (= (travel-duration road_0168) 16.6838)
  (road-next road_0168 road_0085)
  (road-next road_0168 road_0086)
  (connects road_0169 loc_0106 loc_0122)
  (road-open road_0169)
  (= (congestion-factor road_0169) 1.43)
  (= (travel-duration road_0169) 8.4276)
  (road-next road_0169 road_0197)
  (connects road_0171 loc_0107 loc_0108)
  (road-open road_0171)
  (= (congestion-factor road_0171) 1.23)
  (= (travel-duration road_0171) 6.5094)
  ...
  (= (travel-duration road_0177) 19.0643)
  ...
  (= (travel-duration road_0186) 6.8976)
  ...
  (= (travel-duration road_0188) 21.3187)
  ...
  (= (travel-duration road_0189) 7.9592)
  ...
  (= (travel-duration road_0197) 1.3911)
  ...
  (= (travel-duration road_0199) 18.7582)
  ...
  (= (travel-duration road_0204) 6.9782)
  ...
  (road-open road_0206)
  (= (congestion-factor road_0206) 1.09)
  (= (travel-duration road_0206) 4.6737)
  ...
  (= (travel-duration road_0211) 23.2884)
  ...
  (= (travel-duration road_0213) 6.2815)
  ...
  (= (travel-duration road_0220) 7.7196)
  ...
  (road-open road_0225)
  (= (congestion-factor road_0225) 1.09)
  (= (travel-duration road_0225) 2.6449)
  ...
  (road-open road_0231)
  (= (congestion-factor road_0231) 1.09)
  (= (travel-duration road_0231) 18.7208)
  ...
  (= (travel-duration road_0234) 7.58)
  ...
  (= (travel-duration road_0235) 10.7608)
  ...
  (road-open road_0236)
  (= (congestion-factor road_0236) 1.4)
  (= (travel-duration road_0236) 61.3319)
