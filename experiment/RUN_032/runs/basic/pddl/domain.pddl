...
(define (domain road-network)
  ...
  (:action traverse-road-static-road_0011
    :parameters (?v - vehicle ?r - road_type_road_0011 ?from - loc_type_loc_0005 ?to - loc_type_loc_0172)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0012
    :parameters (?v - vehicle ?r - road_type_road_0012 ?from - loc_type_loc_0006 ?to - loc_type_loc_0098)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0015
    :parameters (?v - vehicle ?r - road_type_road_0015 ?from - loc_type_loc_0007 ?to - loc_type_loc_0006)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0018
    :parameters (?v - vehicle ?r - road_type_road_0018 ?from - loc_type_loc_0010 ?to - loc_type_loc_0155)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0021
    :parameters (?v - vehicle ?r - road_type_road_0021 ?from - loc_type_loc_0012 ?to - loc_type_loc_0007)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0026
    :parameters (?v - vehicle ?r - road_type_road_0026 ?from - loc_type_loc_0014 ?to - loc_type_loc_0063)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0029
    :parameters (?v - vehicle ?r - road_type_road_0029 ?from - loc_type_loc_0015 ?to - loc_type_loc_0149)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0037
    :parameters (?v - vehicle ?r - road_type_road_0037 ?from - loc_type_loc_0020 ?to - loc_type_loc_0138)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0038
    :parameters (?v - vehicle ?r - road_type_road_0038 ?from - loc_type_loc_0021 ?to - loc_type_loc_0022)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0039
    :parameters (?v - vehicle ?r - road_type_road_0039 ?from - loc_type_loc_0021 ?to - loc_type_loc_0139)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0040
    :parameters (?v - vehicle ?r - road_type_road_0040 ?from - loc_type_loc_0022 ?to - loc_type_loc_0197)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0043
    :parameters (?v - vehicle ?r - road_type_road_0043 ?from - loc_type_loc_0024 ?to - loc_type_loc_0185)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0044
    :parameters (?v - vehicle ?r - road_type_road_0044 ?from - loc_type_loc_0024 ?to - loc_type_loc_0023)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0045
    :parameters (?v - vehicle ?r - road_type_road_0045 ?from - loc_type_loc_0025 ?to - loc_type_loc_0030)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0047
    :parameters (?v - vehicle ?r - road_type_road_0047 ?from - loc_type_loc_0026 ?to - loc_type_loc_0024)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0049
    :parameters (?v - vehicle ?r - road_type_road_0049 ?from - loc_type_loc_0028 ?to - loc_type_loc_0029)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0057
    :parameters (?v - vehicle ?r - road_type_road_0057 ?from - loc_type_loc_0030 ?to - loc_type_loc_0026)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0069
    :parameters (?v - vehicle ?r - road_type_road_0069 ?from - loc_type_loc_0037 ?to - loc_type_loc_0189)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0072
    :parameters (?v - vehicle ?r - road_type_road_0072 ?from - loc_type_loc_0039 ?to - loc_type_loc_0171)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0073
    :parameters (?v - vehicle ?r - road_type_road_0073 ?from - loc_type_loc_0039 ?to - loc_type_loc_0034)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0075
    :parameters (?v - vehicle ?r - road_type_road_0075 ?from - loc_type_loc_0040 ?to - loc_type_loc_0004)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0076
    :parameters (?v - vehicle ?r - road_type_road_0076 ?from - loc_type_loc_0041 ?to - loc_type_loc_0048)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0082
    :parameters (?v - vehicle ?r - road_type_road_0082 ?from - loc_type_loc_0045 ?to - loc_type_loc_0013)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0084
    :parameters (?v - vehicle ?r - road_type_road_0084 ?from - loc_type_loc_0047 ?to - loc_type_loc_0117)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0085
    :parameters (?v - vehicle ?r - road_type_road_0085 ?from - loc_type_loc_0048 ?to - loc_type_loc_0049)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0087
    :parameters (?v - vehicle ?r - road_type_road_0087 ?from - loc_type_loc_0049 ?to - loc_type_loc_0050)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0088
    :parameters (?v - vehicle ?r - road_type_road_0088 ?from - loc_type_loc_0050 ?to - loc_type_loc_0041)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0092
    :parameters (?v - vehicle ?r - road_type_road_0092 ?from - loc_type_loc_0055 ?to - loc_type_loc_0111)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0100
    :parameters (?v - vehicle ?r - road_type_road_0100 ?from - loc_type_loc_0061 ?to - loc_type_loc_0100)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0102
    :parameters (?v - vehicle ?r - road_type_road_0102 ?from - loc_type_loc_0063 ?to - loc_type_loc_0013)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0109
    :parameters (?v - vehicle ?r - road_type_road_0109 ?from - loc_type_loc_0068 ?to - loc_type_loc_0047)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0111
    :parameters (?v - vehicle ?r - road_type_road_0111 ?from - loc_type_loc_0069 ?to - loc_type_loc_0068)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0120
    :parameters (?v - vehicle ?r - road_type_road_0120 ?from - loc_type_loc_0073 ?to - loc_type_loc_0143)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0121
    :parameters (?v - vehicle ?r - road_type_road_0121 ?from - loc_type_loc_0073 ?to - loc_type_loc_0132)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0126
    :parameters (?v - vehicle ?r - road_type_road_0126 ?from - loc_type_loc_0075 ?to - loc_type_loc_0058)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0130
    :parameters (?v - vehicle ?r - road_type_road_0130 ?from - loc_type_loc_0078 ?to - loc_type_loc_0124)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0149
    :parameters (?v - vehicle ?r - road_type_road_0149 ?from - loc_type_loc_0089 ?to - loc_type_loc_0079)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0158
    :parameters (?v - vehicle ?r - road_type_road_0158 ?from - loc_type_loc_0094 ?to - loc_type_loc_0096)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0159
    :parameters (?v - vehicle ?r - road_type_road_0159 ?from - loc_type_loc_0094 ?to - loc_type_loc_0096)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0163
    :parameters (?v - vehicle ?r - road_type_road_0163 ?from - loc_type_loc_0096 ?to - loc_type_loc_0094)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0164
    :parameters (?v - vehicle ?r - road_type_road_0164 ?from - loc_type_loc_0096 ?to - loc_type_loc_0094)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0165
    :parameters (?v - vehicle ?r - road_type_road_0165 ?from - loc_type_loc_0096 ?to - loc_type_loc_0093)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0167
    :parameters (?v - vehicle ?r - road_type_road_0167 ?from - loc_type_loc_0097 ?to - loc_type_loc_0145)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0170
    :parameters (?v - vehicle ?r - road_type_road_0170 ?from - loc_type_loc_0098 ?to - loc_type_loc_0097)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0174
    :parameters (?v - vehicle ?r - road_type_road_0174 ?from - loc_type_loc_0100 ?to - loc_type_loc_0101)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0181
    :parameters (?v - vehicle ?r - road_type_road_0181 ?from - loc_type_loc_0104 ?to - loc_type_loc_0115)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0182
    :parameters (?v - vehicle ?r - road_type_road_0182 ?from - loc_type_loc_0105 ?to - loc_type_loc_0091)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0183
    :parameters (?v - vehicle ?r - road_type_road_0183 ?from - loc_type_loc_0106 ?to - loc_type_loc_0017)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0184
    :parameters (?v - vehicle ?r - road_type_road_0184 ?from - loc_type_loc_0108 ?to - loc_type_loc_0106)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0188
    :parameters (?v - vehicle ?r - road_type_road_0188 ?from - loc_type_loc_0111 ?to - loc_type_loc_0109)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0191
    :parameters (?v - vehicle ?r - road_type_road_0191 ?from - loc_type_loc_0112 ?to - loc_type_loc_0172)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0201
    :parameters (?v - vehicle ?r - road_type_road_0201 ?from - loc_type_loc_0117 ?to - loc_type_loc_0116)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0206
    :parameters (?v - vehicle ?r - road_type_road_0206 ?from - loc_type_loc_0122 ?to - loc_type_loc_0075)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0210
    :parameters (?v - vehicle ?r - road_type_road_0210 ?from - loc_type_loc_0124 ?to - loc_type_loc_0196)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0222
    :parameters (?v - vehicle ?r - road_type_road_0222 ?from - loc_type_loc_0130 ?to - loc_type_loc_0167)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0223
    :parameters (?v - vehicle ?r - road_type_road_0223 ?from - loc_type_loc_0131 ?to - loc_type_loc_0160)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0225
    :parameters (?v - vehicle ?r - road_type_road_0225 ?from - loc_type_loc_0132 ?to - loc_type_loc_0195)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0229
    :parameters (?v - vehicle ?r - road_type_road_0229 ?from - loc_type_loc_0134 ?to - loc_type_loc_0136)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0237
    :parameters (?v - vehicle ?r - road_type_road_0237 ?from - loc_type_loc_0138 ?to - loc_type_loc_0021)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0238
    :parameters (?v - vehicle ?r - road_type_road_0238 ?from - loc_type_loc_0139 ?to - loc_type_loc_0140)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0240
    :parameters (?v - vehicle ?r - road_type_road_0240 ?from - loc_type_loc_0140 ?to - loc_type_loc_0108)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0244
    :parameters (?v - vehicle ?r - road_type_road_0244 ?from - loc_type_loc_0142 ?to - loc_type_loc_0170)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0253
    :parameters (?v - vehicle ?r - road_type_road_0253 ?from - loc_type_loc_0149 ?to - loc_type_loc_0173)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0263
    :parameters (?v - vehicle ?r - road_type_road_0263 ?from - loc_type_loc_0155 ?to - loc_type_loc_0011)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0270
    :parameters (?v - vehicle ?r - road_type_road_0270 ?from - loc_type_loc_0161 ?to - loc_type_loc_0053)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0275
    :parameters (?v - vehicle ?r - road_type_road_0275 ?from - loc_type_loc_0164 ?to - loc_type_loc_0123)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0276
    :parameters (?v - vehicle ?r - road_type_road_0276 ?from - loc_type_loc_0165 ?to - loc_type_loc_0078)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0278
    :parameters (?v - vehicle ?r - road_type_road_0278 ?from - loc_type_loc_0167 ?to - loc_type_loc_0168)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0283
    :parameters (?v - vehicle ?r - road_type_road_0283 ?from - loc_type_loc_0171 ?to - loc_type_loc_0105)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0284
    :parameters (?v - vehicle ?r - road_type_road_0284 ?from - loc_type_loc_0172 ?to - loc_type_loc_0112)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0285
    :parameters (?v - vehicle ?r - road_type_road_0285 ?from - loc_type_loc_0172 ?to - loc_type_loc_0005)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0292
    :parameters (?v - vehicle ?r - road_type_road_0292 ?from - loc_type_loc_0176 ?to - loc_type_loc_0131)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0301
    :parameters (?v - vehicle ?r - road_type_road_0301 ?from - loc_type_loc_0181 ?to - loc_type_loc_0015)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0304
    :parameters (?v - vehicle ?r - road_type_road_0304 ?from - loc_type_loc_0183 ?to - loc_type_loc_0184)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0305
    :parameters (?v - vehicle ?r - road_type_road_0305 ?from - loc_type_loc_0184 ?to - loc_type_loc_0198)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0306
    :parameters (?v - vehicle ?r - road_type_road_0306 ?from - loc_type_loc_0185 ?to - loc_type_loc_0186)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0308
    :parameters (?v - vehicle ?r - road_type_road_0308 ?from - loc_type_loc_0186 ?to - loc_type_loc_0185)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0314
    :parameters (?v - vehicle ?r - road_type_road_0314 ?from - loc_type_loc_0189 ?to - loc_type_loc_0178)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0320
    :parameters (?v - vehicle ?r - road_type_road_0320 ?from - loc_type_loc_0194 ?to - loc_type_loc_0082)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0322
    :parameters (?v - vehicle ?r - road_type_road_0322 ?from - loc_type_loc_0195 ?to - loc_type_loc_0132)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-road_0323
    :parameters (?v - vehicle ?r - road_type_road_0323 ?from - loc_type_loc_0195 ?to - loc_type_loc_0159)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
