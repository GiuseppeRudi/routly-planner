...
(define (domain road-network)
  ...
  (:action traverse-road-static-macro_0017
    :parameters (?v - vehicle ?r - road_type_macro_0017 ?from - loc_type_loc_0096 ?to - loc_type_loc_0166)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
  ...
  (:action traverse-road-static-macro_0034
    :parameters (?v - vehicle ?r - road_type_macro_0034 ?from - loc_type_loc_0244 ?to - loc_type_loc_0245)
    :precondition (and
      (at ?v ?from)
      (connects ?r ?from ?to)
      (road-open ?r)
