;; ============================================================
;;  PROBLEM: exp_300_nodes_03_planner_comp_node_comp_20260715_190912
;;  Features: tl_cong-pddl-static_llm_macro
;;  Start: loc_0189
;;  Goal:  loc_0170
;; ============================================================

(define (problem exp_300_nodes_03_planner_comp_node_comp_20260715_190912_dynamic)
  (:domain road-network)
  ...
  (road-open road_0149)
  ;; [DYNAMIC EVENT - robbery] Robbery on roads 0149 and 0473 at junction loc_0282, a bridge node connecting to loc_0093, causing a detour.
  ...
  (road-open road_0152)
  ;; [DYNAMIC EVENT - roadworks] Roadworks on roads 0152 and 0454 at junction loc_0094, a low-degree node linking to the main corridor, forcing a detour.
  ...
  (road-open road_0153)
  ;; [DYNAMIC EVENT - accident] Accident on road_0153 blocks traffic between loc_0094 and loc_0093, a key link close to the direct path.
  ...
  (road-open road_0216)
  (= (congestion-factor road_0216) 2.5)  ;; [DYNAMIC EVENT - slowdown] Light congestion on road_0216 reduces speed by a factor of 2.5, affecting the link between loc_0126 and loc_0124.
  (= (travel-duration road_0216) 24.2373)  ;; [DYNAMIC EVENT - slowdown] Light congestion on road_0216 reduces speed by a factor of 2.5, affecting the link between loc_0126 and loc_0124.
