% Routly Planner scientific-report template.
% Evidence source documents:
% - docs/congestione_dinamica_ottimizzata.docx
% - docs/ottimizzazioni_pddl_plus_scalabilita_routly.docx
% - docs/report_macro_road_abstraction.docx
% Build from this directory with: pdflatex report.tex
